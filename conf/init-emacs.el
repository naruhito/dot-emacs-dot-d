...
(defkey flymake-mode-map "C-c C-p" 'flymake-goto-prev-error)
(defkey flymake-mode-map "C-c C-n" 'flymake-goto-next-error)
(defkey flymake-mode-map "C-c C-a" 'flymake-show-buffer-diagnostics)
...
(defkey treesit-fold-mode-map "<tab>" 'my/treesit-fold-or-indent)
(defkey treesit-fold-mode-map "TAB" 'my/treesit-fold-or-indent)
(defkey treesit-fold-mode-map "<backtab>" 'my/treesit-fold-toggle-all)
(defkey treesit-fold-mode-map "C-c f t" 'treesit-fold-toggle)
(defkey treesit-fold-mode-map "C-c f r" 'treesit-fold-open-recursively)
(defkey treesit-fold-mode-map "C-c f c" 'treesit-fold-close-all)
(defkey treesit-fold-mode-map "C-c f o" 'treesit-fold-open-all)
...
(gdefkey "C-z C-c n" 'copilot-chat)
(gdefkey "C-z C-c d" 'copilot-chat-display)
(gdefkey "C-z C-c c" 'copilot-chat-compose)
(gdefkey "C-z C-r" 'copilot-chat-review)
