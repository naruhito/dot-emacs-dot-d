...
(defkey treesit-fold-mode-map "C-c C-f t" 'treesit-fold-toggle)
(defkey treesit-fold-mode-map "C-c C-f c" 'treesit-fold-close-all)
(defkey treesit-fold-mode-map "C-c C-f o" 'treesit-fold-open-all)
