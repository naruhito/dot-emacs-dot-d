...
;; Version: $Id: bm.el,v 1.55 2011/03/29 21:32:56 jood Exp $
...
(defconst bm-version "$Id: bm.el,v 1.55 2011/03/29 21:32:56 jood Exp $"
...
(defface bm-face
  '((((class grayscale)
    ...
    (((class color)
      (background light)) (:foreground "White" :background "#AAAA1D" :weight bold))
    (((class color)
      (background dark))  (:foreground "White" :background "#AAAA1D" :weight bold)))
